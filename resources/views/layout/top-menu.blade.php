...
@section('content')
    ...
    <div class="border-b border-white/[0.08] -mt-10 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 pt-3 md:pt-0 mb-10">
        <div class="top-bar-boxed flex items-center">
            ...
            <a href="" class="-intro-x hidden md:flex">
                <img alt="{{ auth()->user()->name }}" class="w-6" src="{{ asset('dist/images/logo.svg') }}">
    ...
    <!-- Removed 'notification--light' and 'dark:text-slate-500' to avoid washed-out text -->
    <div class="dropdown-toggle notification notification--bullet cursor-pointer" 
         role="button" 
         aria-expanded="false" 
         data-tw-toggle="dropdown">
        <i data-feather="bell" class="notification__icon text-slate-600"></i>
    </div>

    <div class="notification-content pt-2 dropdown-menu">
        <!-- Add 'bg-white' and 'shadow' for better visibility -->
        <div class="notification-content__box dropdown-content bg-white shadow">
            <div class="notification-content__title text-slate-800">Notifications</div>
            ...
            @foreach (array_slice($fakers, 0, 5) as $key => $faker)
                <div class="cursor-pointer relative flex items-center {{ $key ? 'mt-5' : '' }}">
                    <div class="w-12 h-12 flex-none image-fit mr-1">
                        ...
                        <div class="w-3 h-3 bg-success absolute right-0 bottom-0 
                    ...
                    <div class="ml-2 overflow-hidden">
                        <div class="flex items-center">
                            ...
                            <a href="javascript:;" 
                               class="font-medium truncate mr-5 text-slate-800">
                                {{ $faker['users'][0]['name'] }}
                            </a>
                            <!-- Slightly darker text for the time -->
                            <div class="text-xs text-slate-600 ml-auto whitespace-nowrap">
                                {{ $faker['times'][0] }}
                            </div>
                        </div>
                        
                        <!-- Darker text for the short content -->
                        <div class="w-full truncate text-slate-600 mt-0.5">
