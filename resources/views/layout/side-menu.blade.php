...
@section('content')
    ...
    <div class="flex min-h-screen">
        <!-- BEGIN: Side Menu -->
        <nav class="side-nav h-full overflow-y-auto">
            <a href="" class="intro-x flex justify-center items-center pl-5 pt-4 space-x-2">
                {{-- <img alt="IMS Scholarship Portal" class="w-[4rem]" src="{{ asset('ims_logo.png') }}"> --}}
                <span class="text-4xl font-semibold rounded-0 text-green-600 hover:text-green-800 tracking-wide">IMS</span>
            </a>
