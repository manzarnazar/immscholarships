...
@section('subhead')
    @isset($degree)
        <title>Update Bachelor Degree - IMS - Scholarship Portal</title>
    @else
        <title>Create Bachelor Degree - IMS - Scholarship Portal</title>
    @endisset
@endsection
        ...
        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
            ...
            <div class="intro-y box lg:mt-5">
                <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Bachelor Degree Information </h2>
                </div>
                <div class="p-5">
                    <div class="flex flex-col-reverse xl:flex-row flex-col">
                        <div class="flex-1 mt-6 xl:mt-0">
                            <form id="updateForm" action="@isset($degree){{ route('degree-education-update', $degree->id) }}@else{{ route('degree-education-store') }}@endisset" method="POST" enctype="multipart/form-data">
                                @csrf
                                @isset($degree)
                                    @method('PUT')
                                @endisset
