    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
            ...
            <div class="intro-y box lg:mt-5">
                ...
                <div class="p-5">
                    <form id="courseForm" method="POST" action="{{ route('admin-courses-update', $course->id) }}" enctype="multipart/form-data">
                        @csrf
                        @isset($course)
                            @method('PUT')
                        @endisset
                        ...
                        <div class="grid grid-cols-12 gap-x-5">
                            ...
                            <div class="col-span-12 2xl:col-span-6 mt-3">
                              ...
                              <div class="col-span-12 2xl:col-span-6 mt-3">
                                <div>
                                    <label for="teaching_language" class="form-label">Status</label>
                                    <select name="status" id="teaching_language" class="form-control">
                                        <option value="">Select Status </option>
                                        <option value="AVAILABLE" @isset($course) @if ($course->status == 'AVAILABLE') selected @endif @endisset>Available</option>
                                        <option value="NOT AVAILABLE" @isset($course) @if ($course->status == 'NOT AVAILABLE') selected @endif @endisset>
                            ...
                            <div class="col-span-12 2xl:col-span-6 mt-3">
                                <div>
                                    ...
                                    @isset($course)
                                        <img src="{{ asset($course->image_path) }}" alt="Cover Image" class="mt-2" style="max-width: 200px;">
                                    @endisset
                                </div>
                            </div>
