                        ...
                        <div class="flex-1 mt-6 xl:mt-0">
                            <form id="institutionForm" method="POST"
                                ...
                                <div class="grid grid-cols-12 gap-x-5">
                                    ...
                                    <div class="col-span-12 2xl:col-span-6">
                                        <div class="mt-3">
                                            ...
                                            <input id="name" name="name" type="text" class="form-control"
                                                ...
                                                value="@isset($institution){{ $institution->name }}@endisset">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-12 2xl:col-span-6 mt-3">
                                        <div>
                                            ...
                                            <input id="province" name="province" type="text" class="form-control"
                                                ...
                                                value="@isset($institution){{ $institution->province }}@endisset">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-12 2xl:col-span-6 mt-3">
                                        <div>
                                            ...
                                            <input id="city" name="city" type="text" class="form-control"
                                                ...
                                                value="@isset($institution){{ $institution->city }}@endisset">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-12 2xl:col-span-6 mt-3">
                                        <div>
                                            ...
                                            <input id="duration" name="duration" type="text" class="form-control"
                                                ...
                                                value="@isset($institution){{ $institution->duration }}@endisset">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-12 2xl:col-span-6 mt-3">
                                        <div>
                                            <label for="ims_fee" class="form-label">IMS Service Fee</label>
