...
@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">Student Personal Information</h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">

            <a href="{{ route('basic-info-create') }}" class="btn btn-primary shadow-md mr-2">Add Info</a>
            {{-- <a href="{{ route('basic-info-create') }}" class="btn btn-warning shadow-md mr-2">Edit Info</a> --}}
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="text-center whitespace-nowrap">Birth Country</th>
                        <th class="text-center whitespace-nowrap">Highest Education</th>
