...
@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">Passport Information</h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('passport-info-create') }}" class="btn btn-primary shadow-md mr-2">Add Info</a>
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        <th class="whitespace-nowrap">Passport Image</th>
                        <th class="whitespace-nowrap">Last Name</th>
                        <th class="whitespace-nowrap">First Name</th>
                        <th class="text-center whitespace-nowrap">Passport Number</th>
                        <th class="text-center whitespace-nowrap">Issued Date</th>
                        <th class="text-center whitespace-nowrap">Expiry Date</th>
                        <th class="text-center whitespace-nowrap">ACTIONS</th>
                    </tr>
                </thead>
                <tbody id="passport-data">
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            function fetchPassportData(page = 1) {
                let search = $('#search').val();
                let entriesPerPage = $('#entries-per-page').val();
                $.ajax({
                    url: '{{ route("ajax.passports") }}',
                    type: 'GET',
                    data: {
                        search: search,
                    ...
                    success: function(response) {
                        $('#passport-data').html(response.data);
